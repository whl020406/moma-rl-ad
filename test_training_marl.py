...
agent = MOMA_DQN.MOMA_DQN(env, num_objectives=2, seed=11, replay_buffer_size=10_000, batch_size=100, use_multi_dqn=True, reward_structure="mean_reward", observation_space_name="OccupancyGrid", increase_ego_reward_importance=True, estimate_uncontrolled_obj_weights=True)
