...
loss_logger_df = agent.train(1000, epsilon_start=0.9, epsilon_end=0.1, epsilon_end_time= 0.8, num_evaluations=0)
eval_logger_df, vehicle_logger_df = agent.evaluate(seed=11, episode_recording_interval=10, video_name_prefix="Test_MOMA_7", render_episodes=True)
